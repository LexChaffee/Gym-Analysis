...
Spikes:
Weight and duration has an interesting relationship as there are two spikes in durration for certain weights
...
We can test this using a t-test
...
Durration appears to differ across ExpLvL
